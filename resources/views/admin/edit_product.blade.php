                ...
                <form class="form-horizontal" method="post" action="{{ URL::to('/update_product',$specific_edit_product->product_id) }}" enctype="multipart/form-data">
                    ...
                    <fieldset>
                            ...
                            <div class="controls">
                                <select name="brand_id" id="" required>
                                    ...
                                    foreach ($all_published_brand as $view_brand){
                                        ?>
                                    <option value="{{ $view_brand->brand_id }}"<?php if($specific_edit_product->brand_id == $view_brand->brand_id ){echo "selected";}?>>{{ $view_brand->brand_name }}</option>
                                    <?php } ?>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="product_description" id="textarea2" rows="3" required>
                                    {{ $specific_edit_product->product_description }}
                                </textarea>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" value="{{ $specific_edit_product->product_price }}" name="product_price" class="span6 typeahead" id="typeahead"  required> Php
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" value="{{ $specific_edit_product->product_size }}" name="product_size" class="span6 typeahead" id="typeahead"  required>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="typeahead">Product Color</label>
                            <div class="controls">
                                <input type="text" value="{{ $specific_edit_product->product_color }}" name="product_color" class="span6 typeahead" id="typeahead"  required>
                            </div>
                        </div>
